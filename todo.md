...
- [x] Push the latest Nightfall source state to the private GitHub repository and deliver a sanitized source ZIP excluding secrets, private data, dependencies, build output, and runtime artifacts. Pushed commit `8eaf8fb`; ZIP created from `git archive` and scanned for credential-shaped values and forbidden runtime artifacts.
