...
- [x] Add source-change monitoring that records official-source snapshots, shows reviewable differences, and never silently changes a student’s application plan. Existing opt-in source watches already retain normalized source caches, prior text, hashes, and review alerts; the new workspace links directly to that watch surface.
