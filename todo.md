...
- [ ] Push the latest Nightfall source state to the private GitHub repository and deliver a sanitized source ZIP excluding secrets, private data, dependencies, build output, and runtime artifacts.
